    ...
    <>
      ...
      <main>
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-1/2 -translate-x-1/2 hidden sm:flex flex-col items-center gap-1"
          aria-hidden="true"
        >
          <span className="text-xs text-ink-muted/50 mb-2">Scroll</span>
          <motion.svg
            animate={{ y: [0, 6, 0] }}
